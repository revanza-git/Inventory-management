...
<h1>Stock Keluar {{ucfirst($namaPart)}} (LAMPAU)</h1>

<div class="mt-4 col-8 ">

    <form action="/inventory/minusOldStock/{{$dataId}}" enctype="multipart/form-data" method="POST">
        @csrf
            <div class="form-floating mb-3">
                <input type="date" class="form-control" id="floatingInput" name="dtStockPartApprovedOut" required value="{{old('dtStockPartApprovedOut')}}">
                <label for="floatingInput">Tanggal FKB</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com"  name="noFkb" required>
            ...
            <div class="form-floating mb-3">
                <input type="date" class="form-control" id="floatingInput" name="dtStockPartOut" required 
            ...
            <div class="form-floating mb-3">
                <input type="number" class="form-control @error('priceStockPartOut') is-invalid @enderror" id="floatingInput" placeholder="name@example.com" min="0" required name="priceStockPartOut" value="{{old('priceStockPartOut')}}">
                <label for="floatingInput">Harga Satuan</label>
            </div>
            <div class="form-floating mb-3">
                <input type="number" class="form-control @error('yearStockPartOut') is-invalid @enderror" id="floatingInput" placeholder="name@example.com" min="2000" required name="yearStockPartOut" value="{{old('yearStockPartOut')}}">
            ...
            <div class="form-floating mb-3">
                ...
                value="{{old('needsStockPartOut')}}" required>
