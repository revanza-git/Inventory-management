...
@endif
<h1>Request Approval In (DOCS)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            ...
                            href="aprroveInAdminDate/{{$data->dtStockPartIn}}/{{$data->nameRequester}}/{{$data->lokasiPart}}/{{$data->departmentRequester}}/{{$data->kategoriMaterial}}">
                            Form Pengajuan oleh
                            {{$data->nameRequester}}
