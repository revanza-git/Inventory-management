...
@endif
<h1>Request Approval Out (FISIK)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            ...
                            href="aprroveOutAdminFisik/{{$data->dtStockPartOut}}/{{$data->nameRequester}}/{{$data->lokasiPart}}/{{$data->departmentRequester}}/{{$data->kategoriMaterial}}">
                            Form Pengajuan oleh
                            {{$data->nameRequester}}
                            ({{$data->departmentRequester}}) ({{Carbon\Carbon::parse($data->dtStockPartOut)->isoFormat('LL');}})
