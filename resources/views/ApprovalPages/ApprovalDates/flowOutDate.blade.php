...
@endif
<h1>Request Approval Out (DOCS)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            ...
                            href="aprroveOutAdminDate/{{$data->dtStockPartOut}}/{{$data->nameRequester}}/{{$data->lokasiPart}}/{{$data->departmentRequester}}/{{$data->kategoriMaterial}}">
                            Form Pengajuan oleh
                            {{$data->nameRequester}}
