...
<div class="mt-3 mb-3">
    @if( !empty($list[0]->ReasonThirdApprovalDocsPartIn))
            <div class="card col-7  bg-info text-white cardCustom">
                <div class="cardCustom">
                    <h5>Revisi dari {{$list[0]->nameThirdApprovalDocsPartIn}} pada {{$list[0]->timeThirdApprovalDocsPartIn}} :</h5>
                    <h6 style="margin-left: 20px;">{{$list[0]->ReasonThirdApprovalDocsPartIn}}</h6>
                </div>
            </div>    
    @endif  
</div>
