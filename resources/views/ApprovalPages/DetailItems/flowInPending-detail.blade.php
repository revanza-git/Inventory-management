...
<div class="mt-4">
    ...
    <div class="table-responsive-sm mt-6">
        <table class="table table-bordered table-hover mt-3 table-striped">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if (auth()->user()->role =='admin' && $data->firstApprovalPartIn =! 'Reject')
                            <a type="button" 
                            ...
                            href="/inventory/rejectDokumenIn/{{$data->id_flowInPart}}">Reject</a>
                        @endif 
                    </td>
        ...
        @if( !empty($data->ReasonFirstApprovalPartIn))
        ...
        @endif
        @if( !empty($data->ReasonSecondApprovalPartIn))
            <div class="card col-5 mt-4 bg-info text-white cardCustom">
