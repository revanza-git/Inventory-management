...
<h1>Request Approval In
    {{ucwords(auth()->user()->role)}}
    of
    {{ucwords(auth()->user()->departement)}} (DOCS)
</h1>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            ...
                            href="aprroveInHead/{{$data->dtStockPartIn}}/{{$data->nameRequester}}/{{$data->lokasiPart}}/{{$data->departmentRequester}}/{{$data->kategoriMaterial}}">
                            Form Pengajuan oleh
                            {{$data->nameRequester}}
