...
<div class="mt-4 col-8 ">
    ...
    <form action="/{{$category}}/{{$data->idPart}}" method="POST">
        ...
        <div class="form-floating mb-3">
            <textarea
                class="form-control @error('descPart') is-invalid @enderror"
                placeholder="Leave a comment here"
                id="floatingTextarea2"
                style="height: 100px"
                name="descPart">{{$data->descPart}}</textarea>
        ...
        <div class="form-floating mb-3">
            <input
                type="text"
                class="form-control @error('lokasiPart') is-invalid @enderror"
                id="floatingInput"
        ...
        <div class="mb-3">
            ...
            <input
                type="text"
                class="form-control  @error('satuanPart') is-invalid @enderror"
                id="floatingInput"
                placeholder="Satuan"
                name="satuanPart"
                value="{{$data->satuanPart}}"
