    ...
    <div style="padding: 20px">
        ...
        <table style="width:100%">
            <tr>
                ...
                <th style="text-align: center;">Formulir Terima Barang</th>
            </tr>
            <tr>
        ...
        <div class="card col-8 mt-3 ">
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li><p class="card-subtitle mt-2 text-white">Departemen/Penyedia B/J : Dept.{{$department}}</p></li>
                            <li><p class="card-subtitle mt-2 text-white">No Terima Barang: {{$noFtb}}</p></li>
                            <li><p class="card-subtitle mt-2 text-white">Tanggal Terima: {{Carbon\Carbon::parse($list[0]->dtStockPartApprovedIn)->isoFormat('LL');}}</p></li>
                        </ol>
                        ...
                        <table  style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right:50px;">{{$list[0]->nameThirdApprovalPartIn}}</td>
                                    <td style="padding-right:50px;">{{$list[0]->nameFirstApprovalPartIn}}</td>
                                    <td style="padding-right:50px;">{{$list[0]->nameFourthApprovalPartIn}}</td>
                                </tr>
                            </tbody>
                        </table>
