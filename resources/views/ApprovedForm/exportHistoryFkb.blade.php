    ...
    <div style="padding: 20px">
        ...
        <table style="width:100%">
            <tr>
                ...
                <th style="text-align: center;">Histori Formulir Keluar Barang</th>
            </tr>
            <tr>
                <th style="text-align: center;">No FKB : {{$noFkb}}</th>
            </tr>
        </table>
            ...
            <table id="tableFormCustom" class="table table-bordered table-hover mt-2 table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{Carbon\Carbon::parse($dtStockPartOut)->isoFormat('LL');}}</td>
                    ...
                    <tr>
                        ...
                        <td scope="row">All Items</td>
                        <td scope="row">Nomor Keluar Barang Dirilis</td>
                        <td>{{Carbon\Carbon::parse($tanggalFkb)->isoFormat('LL');}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                </tbody>
